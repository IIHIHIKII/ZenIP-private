...
-   Create ZenIP template(s)
-   Create/Merge ZenIP Repo
-   setup ZenIP related email address -> ZenIP@horizen.global (forward to editors -> Maurizio, Peter, Jonas)
-   setup ZenIP Discord channel to vet ideas before a proper proposal is created.
-   "prepare" the forum/wiki/medium/Kialo of choice for ZenIP related discussions
-   specify usage of discussion platform
...
# ZenIP-42000
    ...
    Comments-URI: https://www.kialo.com/invited?token=005-75a82c99-670e-4ac4-be8d-668acc9ac917
    Status: Draft 
    Type: Process
    Created: 2019-09-05
    License: MIT
...
- [ZenIP Comments](#zenip-comments)
  * [Discussion Tool](#discussion-tool)
...
to the public [Discussion Tool](#discussion-tool).
...
submitted to the [ZenIP GitHub repository]() as a pull request. The draft
...
**TODO decision thresholds**
Editors will have to make a number of decision and unanimity cannot be assumed and is not necessary for all kinds of decisions.
When we say *majority decision* this means more than half (>50%) of the Editors need to agree.
When we say *supermajority decision* this means more than two thirds (>66.7%) need to agree.
Additionally, there are decisions that require *unanimity*.

### Adding and Removing Editors

Additional Editors may be added by consensus among the current 
...
-   Motivation and backward compatibility (when applicable) must be
    addressed.
-   ZenIPs must licensed according to the [ZenIP licensing](#zenip-licensing) requirements

If the ZenIP isn't ready, an Editor will send it back to the Owner for
...
<ZenIPs@horizen.global>, or by opening an issue on the **ZenIPs issue tracker link**. All communications should abide by the **Horizen Code of Conduct** and follow [the GNU Kind Communication Guidelines](https://www.gnu.org/philosophy/kind-communication.en.html)
...
there needs to be *supermajority* consensus among the Editors.
...
objections may be ignored/overruled by general agreement of the Editors that they have
...
Comments from the community on ZenIPs should occur in a dedicated channel
for the ZenIP in our [Discord channel](https://discordapp.com/invite/Hu5mQxR)
...
Each ZenIP should, in its preamble, link to a dedicated discussion. Reviewers of the ZenIP who consider themselves qualified, should post their own comments on this page. The discussion will be moderated according to the **Link: Horizen Code of Conduct**.
...
- we want open-spurce contributions
- need to protect ourselves against contribution protected with patents
- need to protect ourselves against people patenting parts of Horizen

**TODO Patent covenant - What about this (short permissive patent clause): The licensee is allowed to use, reproduce, build upon, build over, develop, the patented products and processes based on the description, drawings and claims of the given patents.**

### Specification

Each new ZenIP MUST identify what license it is licensed under in its preamble.
We strongly recommend the use of the MIT license for all ZenIPs.

In case the project being modified is licensed differently, it is RECOMMENDED that the literal code included in the ZenIP
be dual-licensed - under MIT license and the same license terms as the project it
modifies. Each license MUST be referenced by their respective abbreviation given below.
...
MIT license as well as the GNU All-Permissive
...
When compelling reasons are presented the editors may choose to add ZenIPs
which are licensed differently, at their discretion.
...
Please reach out to [ZenIP@horizen.global](mailto:zenip@horizen.global) in case you want to contribute but are not willing to use the license(s) specified above.
