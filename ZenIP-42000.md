...
-   it violates the laws of any of the editors respective jurisdiction;
...
When the Editors approve a pull request, assign it a number and the status changes to *Proposed* a dedicated channel in our Discord will be created for it.
...
We cannot accept ZenIPs whose content, either in written word or code is protected by patents.
...
Please reach out to [ZenIP@horizen.global](mailto:zenip@horizen.global) in case you want to contribute but are unwilling to use the MIT license for any reason.
