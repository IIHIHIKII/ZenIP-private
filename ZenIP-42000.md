...
To ask the community the Owner can start in our **Discord ZenIP channel**.
...
submitted to the **ZenIP GitHub repository (link)** as a pull request. The draft
...
Editors: **TODO: one from the Zen Blockchain Foundation and one from the Horizen Community Council.**

Each organization has its own process for assigning its representative
editor.

**TODO decision thresholds**
Editors will have to make a number of decision and unanimity cannot be assumed for all decisions.
When we say *majority decision* this means more than 50% of Editors need to agree.
...
These conventions are subject to change by a *majority* of the ZenIP Editors.
...
there needs to be **TODO: supermajority** consensus among the Editors.
